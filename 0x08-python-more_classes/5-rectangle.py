#!/usr/bin/python3
"""
Adding __del__ methode in a class.
"""
...
class Rectangle:
    ...
    def height(self, value):
        """Property setterthat sets the value of the rectangle height."""
        if isinstance(value, int):
            if value < 0:
    ...
    def __str__(self):
        """Standard methode that returns the rectangle with the character #."""
        rectangle = ""
