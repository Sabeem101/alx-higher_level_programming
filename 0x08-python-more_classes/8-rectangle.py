#!/usr/bin/python3
"""
Adding a static methode to the rectangle class.
"""
...
class Rectangle:
    ...
    @property
    def height(self):
        """Property that retrieves the retangle height."""
    ...
    def __del__(self):
        """Destructor methode that printd a string when the rectangle is deleted"""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1

    @staticmethod
    def bigger_or_equal(rect_1, rect_2):
        """Static methode that returns the biggest rectangle on area."""
